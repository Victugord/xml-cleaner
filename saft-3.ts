...
export enum TransactionDescription {
    ...
    DepositosBancários = "Depositos Bancários",
    ...
    ProcessamentoSalários = "Processamento Salários",
...
export interface SourceDocumentID {
    ...
    InvoiceDate:   Date;
    Description:   SourceDocumentIDDescription;
}

export enum SourceDocumentIDDescription {
    Factura = "Factura",
    NFaturaNºFICA2097 = "N/ fatura n.º FIC A/2097",
    NotaDeCrédito = "Nota de crédito",
}
